...
def parse_args():
    ...
    # parser.add_argument('-cd3dp', '--checkpoint-d3dp', default='checkpoint', type=str, metavar='PATH',
    #                     help='checkpoint directory')
    # parser.add_argument('-c', '--checkpoint', default='checkpoint/frame1_poseformer_residual', type=str, metavar='PATH',
    #                     help='checkpoint directory')
    # parser.add_argument('-c', '--checkpoint', default='checkpoint/poseformer_residual', type=str, metavar='PATH',
    #                     help='checkpoint directory')
    # parser.add_argument('-cfn', '--checkpoint_fusion', default='checkpoint/poseformer_residual', type=str, metavar='PATH',
    #                     help='checkpoint directory')
    # parser.add_argument('-c', '--checkpoint', default='checkpoint/poseformer_residual_H10_k5', type=str, metavar='PATH',
    #                     help='checkpoint directory')
    # parser.add_argument('-c', '--checkpoint', default='checkpoint/poseformer_mlp', type=str, metavar='PATH',
    #                     help='checkpoint directory')
    # parser.add_argument('-cfn', '--checkpoint_fusion', default='checkpoint/poseformer_mlp', type=str,
    #                     metavar='PATH',
    #                     help='checkpoint directory')
    # parser.add_argument('-c', '--checkpoint', default='checkpoint/earlyfuse_residaul', type=str, metavar='PATH',
    #                     help='checkpoint directory')
    parser.add_argument('-cfn', '--checkpoint_fusion', default='checkpoint/earlyfuse_residaul', type=str,
                        metavar='PATH',
                        help='checkpoint directory')
    # parser.add_argument('-c', '--checkpoint', default='checkpoint/earlyfuse_denseFC', type=str, metavar='PATH',
    #                     help='checkpoint directory')
    # parser.add_argument('-c', '--checkpoint', default='checkpoint/earlyfuse_poseformer', type=str, metavar='PATH',
    #                     help='checkpoint directory')
    # parser.add_argument('-c', '--checkpoint', default='checkpoint/Frame_1_earlyfuse_GCN', type=str, metavar='PATH',
    #                     help='checkpoint directory')
    # parser.add_argument('-c', '--checkpoint', default='checkpoint/poseformer_gcn', type=str, metavar='PATH',
    #                     help='checkpoint directory')
    ...
    parser.add_argument('--evaluate', default='h36m_best_epoch.bin', type=str, metavar='FILENAME',
                        help='checkpoint to evaluate (file name)')
    # parser.add_argument('--evaluate', default='best_epoch_1_frame.bin', type=str, metavar='FILENAME',
    #                     help='checkpoint to evaluate (file name)')  # best_epoch_1_frame.bin
    ...
    parser.add_argument('-lr', '--learning-rate', default=0.001, type=float, metavar='LR',
                        help='initial learning rate') # with residualFC and DenseFC, d3dp:0.00006
    # parser.add_argument('-lr', '--learning-rate', default=0.0001, type=float, metavar='LR',
    #                     help='initial learning rate')
    parser.add_argument('-lrd', '--lr-decay', default=0.993, type=float, metavar='LR',
    ...
    # parser.add_argument('-f', '--number-of-frames', default='1', type=int, metavar='N',
    #                     help='how many frames used as input')
    ...
    # Experimental
    parser.add_argument('-gpu', default='0,1', type=str, help='assign the gpu(s) to use')
    ...
    parser.add_argument('--ftpath', default='checkpoint/exp13_ft2d', type=str,
                        help='assign path of ft2d model chk path')
    ...
    # ft2d.py
    parser.add_argument('-lcs', '--linear_channel_size', type=int, default=1024, metavar='N',
                        help='channel size of the LinearModel')
    parser.add_argument('-depth', type=int, default=4, metavar='N', help='nums of blocks of the LinearModel')
    parser.add_argument('-ldg', '--lr_decay_gap', type=float, default=10000, metavar='N',
                        help='channel size of the LinearModel')
