...
def parse_args():
    ...
    # parser.add_argument('-cd3dp', '--checkpoint', default='checkpoint', type=str, metavar='PATH',
    #                     help='checkpoint directory')
    parser.add_argument('-cd3dp', '--checkpoint-d3dp', default='checkpoint', type=str, metavar='PATH',
                        help='checkpoint directory')
    # parser.add_argument('-c', '--checkpoint', default='checkpoint/fusionNet_model_v1', type=str, metavar='PATH',
    #                     help='checkpoint directory')
    parser.add_argument('-c', '--checkpoint', default='checkpoint/poseformer_v5', type=str, metavar='PATH',
                        help='checkpoint directory')
    # parser.add_argument('-c', '--checkpoint', default='checkpoint/no_share_weight_poseformer_v1', type=str, metavar='PATH',
    #                     help='checkpoint directory')
    # parser.add_argument('-c', '--checkpoint', default='checkpoint/residualFC_fuse_v1', type=str, metavar='PATH',
    #                     help='checkpoint directory')
    # parser.add_argument('-c', '--checkpoint', default='checkpoint/denseFC_fuse_v1', type=str, metavar='PATH',
    #                     help='checkpoint directory')
    ...
    parser.add_argument('-lr', '--learning-rate', default=0.0001, type=float, metavar='LR', help='initial learning rate')  # default 0.00006, 0.0001
    # parser.add_argument('-lr', '--learning-rate', default=0.001, type=float, metavar='LR',
    #                     help='initial learning rate')
    parser.add_argument('-lrd', '--lr-decay', default=0.993, type=float, metavar='LR', help='learning rate decay per epoch')  # default
    # parser.add_argument('-lrd', '--lr-decay', default=0.1, type=float, metavar='LR',
    ...
    parser.add_argument('-num_proposals', type=int, default=10, metavar='N')
